...
Wrote ec2.tf in VS Code - inside terraform-ec2-project folder with provider aws + resource aws_instance
Pushed to GitHub - Repo: terraform-ec2-project (Public) - Fixed HTTP 408 error by adding .terraform/ to .gitignore
